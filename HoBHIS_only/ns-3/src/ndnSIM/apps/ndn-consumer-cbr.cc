...
void
ConsumerCbr::OnContentObject (const Ptr<const ContentObjectHeader> &contentObject,
                               Ptr< Packet> payload)
 {
...
void
 ConsumerCbr::OnNack (const Ptr<const InterestHeader> &interest, Ptr<Packet> origPacket)
 {
//	 Consumer::OnNack (interest, origPacket); // tracing inside
 }
